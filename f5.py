...
FAILURE_ROUNDS = [2, 4, 6, 7, 9]  # 5 falhas (50%)
...
def main():
    print("🚀 INICIANDO COMPARAÇÃO DE ESTRATÉGIAS - 5 FALHAS")
    ...
    print("🔥 CENÁRIO MODERADO: Metade das rodadas com falhas!")
    ...
    print(f"\n{'='*70}")
    print("📈 RESUMO COMPARATIVO - 5 FALHAS (50%)")
    print(f"{'='*70}")
